...
<body style="background-color: black;">
		...
		<header>
			<div class="row bg-dark">
				...
				<div class="col-2" style="margin: 1%">
					...
					<a href="camdetails" class="btn btn-danger">Cam Entry</a>
				</div>
			</div>
		</header>
	</div>
		...
		<table style="color: white;" class="table table-striped table-dark">
			<thead class="thead-dark">
				<tr>
					...
					<th>City</th>
					<th>Phone</th>
					<th>fevorate field</th>
					<th>photography / videography /both</th>
					<th>professional or passion</th>
					<th>Email</th>
					<th>password</th>
				</tr>
			</thead>
			<c:forEach var="u" items="${adminuser }">
				<tr>
					<td>${u.userlogid.fname}</td>
					<td>${u.userlogid.lname}</td>
					<td>${u.userlogid.age}</td>
					<td>${u.userlogid.country}</td>
					<td>${u.userlogid.state}</td>
					<td>${u.userlogid.city}</td>
					<td>${u.userlogid.phone}</td>
					<td>${u.userlogid.fevField}</td>
					<td>${u.userlogid.photographyVideographyBoth}</td>
					<td>${u.userlogid.proffesionalorpassion}</td>
					<td>${u.uemail}</td>
					<td>${u.upassword}</td>
					...
					<td><a class="btn btn-info"
						href="updateUser/${u.id }">edit</a></td>
				</tr>
			</c:forEach>
	...
	<div style="margin-top: 5%;" class="container-fluid position-relative d-flex p-0">
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="https://htmlcodex.com">kishorab023@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
